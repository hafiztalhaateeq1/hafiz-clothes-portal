      ...
      <div className="relative min-h-screen px-4 pt-6 pb-10 sm:px-6 lg:px-8">
        <div className="mx-auto w-full max-w-6xl">
          <div className="relative">
            <div className="absolute right-0 top-1 z-20 sm:top-3">
          ...
          <header className="flex justify-center pt-4 lg:justify-start lg:pt-6">
            <div className="rounded-full border border-white/65 bg-white/45 px-5 py-3 shadow-lg shadow-[#800000]/8 backdrop-blur-xl sm:px-6">
              <div className="flex flex-col items-center gap-2 text-center lg:flex-row lg:items-center lg:gap-3 lg:text-left">
                ...
                <div className={isUrdu ? "text-center lg:text-right" : undefined}>
                  ...
                  <p className={`mt-1 text-xs font-medium tracking-[0.12em] text-[#7b4a4a] ${isUrdu ? "urdu-text" : ""}`}>
                    {copy.tagline}
                  </p>
                </div>
              </div>
          ...
          <div className="pointer-events-none mx-auto mt-10 max-w-4xl px-4 text-center sm:mt-12">
        ...
        <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-6xl items-start justify-center pt-14 lg:items-center lg:pt-8">
